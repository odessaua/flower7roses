...
// images alt & title
$img_alt = (!empty($data->img_alt)) ? $data->img_alt : $data->name;
$img_title = (!empty($data->img_title)) ? $data->img_title : $data->name;
...
<div class="b-product">
   ...
   <div class="title">
        <?php echo CHtml::link(CHtml::encode($data->name), $product_url) ?>
    </div>
