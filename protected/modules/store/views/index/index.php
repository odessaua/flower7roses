...
<div class="wide_line">
	<span><?=Yii::t('StoreModule.core','Popular products')?></span>
</div>
...
<div id="shares">
	<div class="shared_products">
		<div class="share_list">
			<ul>
				<li class="active"><a href="newest"><?=Yii::t('StoreModule.core','New products')?></a></li>
				<li><a href="added_to_cart"><?=Yii::t('StoreModule.core','Top sales')?></a></li>
			</ul>
		</div>
...
<?php if(sizeof($news)): ?>
	<div class="centered">
		<div class="wide_line">
			<span><?=Yii::t('StoreModule.core','News')?></span>
		...
		<div class="all_news">
			<a href="<?=$n->category->viewUrl?>"><?=Yii::t('StoreModule.core','All news<')?>/a>
		</div>
	</div>
<?php endif ?>
<?php $this->endClip(); ?>